...
class CRM_RaisersEdgeMigration_FieldInfo {
  ...
  public static function getCustomGroups() {
    $customGroups = [
      ...
      'RE_membership_details' => [
        'title' => ts('RE Membership details', array('domain' => 'org.civicrm.raisersedgemigration')),
        'name' => 'RE_membership_details',
        'extends' => 'Membership',
      ],
      'RE_campaign_details' => [
  ...
  public static function getCustomFields($customGroupName) {
    $customGroups = [
      ...
      'RE_membership_details' => [
        're_membership_id' => [
          'label' => ts('RE Member ID', array('domain' => 'org.civicrm.raisersedgemigration')),
          'text_length' => 20,
          'data_type' => 'String',
          'html_type' => 'Text',
