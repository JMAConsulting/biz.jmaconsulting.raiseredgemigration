 ...
 */
class CRM_RaisersEdgeMigration_Upgrader_Base {
  ...
  static public function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_RaisersEdgeMigration_Upgrader(
        'biz.jmaconsulting.raiseredgemigration',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_RaiserEdgeMigration_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
